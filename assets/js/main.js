...
document.addEventListener('DOMContentLoaded', function() {
   ...
   /*=============== LOADING ANIMATION ===============*/
   // Fixed: hide on DOMContentLoaded instead of window.load
   // so spinner doesn't block interaction while images load
   ...
   // Fixed: requestAnimationFrame batches scroll work efficiently
   // passive:true tells browser this won't block scrolling (big INP win)
   let ticking = false
   ...
   /*=============== HOME TYPED JS ===============*/
   // Fixed: retries if Typed.js hasn't loaded yet due to defer
   function initTyped() {
      ...
      const sendEmail = (e) => {
         ...
         if (typeof emailjs !== 'undefined') {
            ...
            .catch((error) => {
               ...
               contactMessage.style.color = '#4ecdc4'
               setTimeout(() => { contactMessage.textContent = '' }, 8000)
               contactForm.reset()
            })
         }
      }
   ...
   // Fixed: grouped reveals reduce observer overhead significantly
   function initScrollReveal() {
      if (typeof ScrollReveal !== 'undefined') {
         ...
         // Grouped: right reveals
         sr.reveal('.home__image, .about__image', {
            origin: 'right',
            distance: '30px',
            duration: 500,
            delay: 100
         ...
         // Grouped: cards and data blocks
         sr.reveal('.projects__card, .resume__data', {
            origin: 'bottom',
            distance: '20px',
            duration: 400,
            delay: 50,
         ...
         // Grouped: general sections
         sr.reveal('.section__title, .contact__data', {
            origin: 'bottom',
            distance: '20px',
            duration: 500,
            delay: 50
   ...
   function initializeDemos() {
      ...
      if (generateColorsBtn) generateColorsBtn.addEventListener('click', generateColors)
